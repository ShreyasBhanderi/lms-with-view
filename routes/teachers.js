...
class TeacherRouter {
    ...
    one(req, res) {
        ...
        teacher_1.default.findOne({ where: {
                id: id
            }
        })
            .then((data) => {
    ...
    update(req, res) {
        const id = req.params.id;
        teacher_1.default.update({ name: req.body.name }, { where: {
                id: id
            }
        })
            .then((data) => {
    ...
    delete(req, res) {
        const id = req.params.id;
        teacher_1.default.destroy({ where: {
                id: id
            }
        })
            .then(() => {
...
exports.default = new TeacherRouter().router;
